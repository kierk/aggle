...
*   After you click on a conversation from the conversations list, a conversation view pops up.
*   The conversation view consists of a series of Message objects about a specific Item.
*/
class ConversationsViewController: JSQMessagesViewController {
    ...
    func setupFirebase() {
        ...
        messagesRef.queryLimitedToNmuberOfChildren(25).observeEventType(FEventType.ChildAdded, withBlock: { (snapshot) in
